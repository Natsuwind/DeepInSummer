...
namespace Discuz.Config
{
    ...
    public class GeneralConfigInfo : IConfigInfo
    {
        ...
        private int m_verifyregisterexpired = 0;//验证邮箱注册请求信息的有效期(天)
        private string m_verifyregisteremailtemp = "尊敬的{0},您在我站提交的注册请求已收到,请点击 <a href=\"{1}\">安全注册链接</a> 完成最后注册.<br/>如无法点击链接,请复制{1} 在浏览器中打开";//验证邮箱注册请求Email内容模板
        ...
        /// 验证邮箱注册请求信息的有效期(天)
        /// </summary>
        public int Verifyregisterexpired
        {
            get { return m_verifyregisterexpired; }
            set { m_verifyregisterexpired = value; }
        }
        ...
        /// 验证邮箱注册请求Email内容模板
        /// </summary>
        public string Verifyregisteremailtemp
        {
            get { return m_verifyregisteremailtemp; }
            set { m_verifyregisteremailtemp = value; }
        }
    }
}
