...
namespace Discuz.Web.Services.DiscuzCloud
{
    ...
    public class QQConnectAuthInfo
    {
        private string appId;
        private string appKey;
        private string mBlogAppKey;

        [JsonPropertyAttribute("connectappid")]
        public string AppId
        {
            get { return appId; }
            set { appId = value; }
        ...
        [JsonPropertyAttribute("connectappkey")]
        ...
        [JsonPropertyAttribute("mblog_app_key")]
        public string MBlogAppKey
        {
            get { return mBlogAppKey; }
            set { mBlogAppKey = value; }
        }
    }
