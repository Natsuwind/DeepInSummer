...
namespace Discuz.Forum
{
    ...
    public class Advertisements
    {
        ...
        public static string GetDoubleAd(string pagename, int forumid)
        {
            ...
            doublestr.AppendFormat("\ntheFloaters.addItem('coupleBannerAdv1','(document.body.clientWidth>document.documentElement.clientWidth ? document.documentElement.clientWidth :document.body.clientWidth )-" + (parameter[2] == "" ? "0" : parameter[2]) + "-90',10,'" + result + "<br /><img src=\"images/common/advclose.gif\" onMouseOver=\"this.style.cursor=\\\'hand\\\'\" onClick=\"closeBanner();\">');");
