...
namespace Discuz.Forum
{
    public class Debates
    {
        ...
        {
           return Discuz.Data.Debates.CheckDebateVoter(tid, stand);
        }

        public static void InsertDebateVoter(int tid, string uidList, int stand)
        {
            Discuz.Data.Debates.InsertDebateVoter(tid, uidList, stand);
        }

        public static int GetDebatePostCountByPosterId(string onlyauthor, int topicId, int posterId, int replies, int stand)
        {
            return Data.Debates.GetDebatePostCountByPosterId(onlyauthor, Posts.GetPostTableId(topicId), topicId, posterId, stand);
        }
    }
}
