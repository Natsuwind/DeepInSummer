...
namespace MultiFileUpload.Classes
{
    ...
    public class FileUploader
    {
        ...
        private MixObjectsSoapClient _client;
        ...
        private void UploadAdvanced()
        {
            ...
            if (bytesRead != 0)
            {
                ...
                //上传当前数据块
                _client.StoreFileAdvancedAsync(_file.FileName, buffer, bytesRead, _initParams, _firstChunk, _lastChunk, Utils.GetCredentialInfo());
