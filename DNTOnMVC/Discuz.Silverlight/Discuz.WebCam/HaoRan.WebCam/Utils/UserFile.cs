...
namespace HaoRan.WebCam
{
    ...
    public class UserFile : INotifyPropertyChanged
    {
        ...
        /// 要截取图片的坐标信息
        /// </summary>
        private HaoRan.WebCam.MixObjectsSoapClient.Point _point;
        /// <summary>
        /// 要截取图片的大小
        /// </summary>
        private HaoRan.WebCam.MixObjectsSoapClient.Size _size;

        /// <summary>
        /// 要截取图片的坐标信息
        /// </summary>
        public HaoRan.WebCam.MixObjectsSoapClient.Point GrabPoint
        {
            get { return _point; }
            set
            {
        ...
        /// 要截取图片的大小
        /// </summary>
        public HaoRan.WebCam.MixObjectsSoapClient.Size GrabSize
        {
            get { return _size; }
            set
            {
                _size = value;
                NotifyPropertyChanged("GrabSize");
            }
        }
