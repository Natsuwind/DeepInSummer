...
namespace Discuz.Common
{
	...
	public class DNTRequest
	{
        ...
        /// </summary>
        /// <param name="strName">参数名称</param>
        /// <param name="isEncodeQuotationMark">是否需要将引号('")html转码</param>
        /// <returns></returns>
        public static string GetHtmlEncodeString(string strName, bool isEncodeQuotationMark)
        {
            string htmlEncode = Utils.HtmlEncode(GetString(strName, false));
            return isEncodeQuotationMark ? htmlEncode.Replace("'", "&acute;").Replace("\"", "&quot;") : htmlEncode;
        }
