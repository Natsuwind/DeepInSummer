...
namespace Discuz.Common
{
    ...
    public class Utils
    {
        ...
        public const string ASSEMBLY_VERSION = "3.9.913";
        ...
        {
            if (Utils.StrIsNullOrEmpty(stringarray) || Utils.StrIsNullOrEmpty(str))
                return false;

            //str = str.ToLower();
            //foreach (string str2 in Utils.SplitString(stringarray.ToLower(), strsplit))
            //{
            //    if (str == str2)
            //        return true;
            //}
        ...
        public static string PHPUrlEncode(string oriString)
        {
            ...
            foreach (char symbol in oriString)
            {
                ...
                {
                    result.Append('%' + (tem < 16 ? "0" : "") + Convert.ToString(tem, 16).ToUpper());
                }
            }
        ...
        public static string GetRootUrl(string forumPath)
        {
            return string.Format("{0}://{1}{2}",
                ...
                HttpContext.Current.Request.Url.Authority, forumPath);
        }
        ...
        /// <summary>
        /// 获取一个字符串的hash值
        /// http://apps.hi.baidu.com/share/detail/34701429
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static int BKDEHash(string str, int hashKey)
        {
            ...
            {
                hash = hash + hashKey + Convert.ToInt32(b);
            }
            return hash;
        }
    }
