        ...
        public ajaxtopicinfo()
        {
            ...
            if (Context.Request.Url.ToString().Contains("forumhottopic") || DNTRequest.GetString("pagename") == "forumhottopic")
            {
                ...
                if (DNTRequest.GetString("search") != "")
                {
                    ...
                    showtype = DNTRequest.GetString("showtype") == "" ? "replies" : DNTRequest.GetQueryString("showtype", true);
            ...
            else
            {
                ...
                posterlist = DNTRequest.GetQueryString("poster", true); // DNTRequest.GetString("poster");
                keylist = DNTRequest.GetQueryString("title", true);
                startdate = DNTRequest.GetQueryString("postdatetimeStart:postdatetimeStart",true);
                enddate = DNTRequest.GetQueryString("postdatetimeEnd:postdatetimeEnd", true);
                currentpage = DNTRequest.GetInt("currentpage", 1);
