...
<tr><td class="item_title" colspan="2">启用 RSS</td></tr>
	...
	<tr>
    	...
    	<tr><td class="item_title" colspan="2">是否启用Silverlight</td></tr>
	<tr>
		<td class="vtop rowform">
			<cc1:RadioButtonList id="silverlight" RepeatLayout="flow" runat="server"  >
				<asp:ListItem Value="1">是</asp:ListItem>
				<asp:ListItem Value="0">否</asp:ListItem>
			</cc1:RadioButtonList>		</td>
		<td class="vtop">开启/关闭Silverlight头像、Silverlight投票、Silverlight图片功能。</td>
	</tr>    
    </table>
