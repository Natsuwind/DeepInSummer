    ...
    public partial class editbbcode : AdminPage
    {
        ...
        private void UpdateBBCodeInfo_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                ...
                replacement.is_replace = example.is_replace = explanation.is_replace = paramsdescript.is_replace = paramsdefvalue.is_replace = false;
