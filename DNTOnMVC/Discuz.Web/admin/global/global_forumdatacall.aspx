<%@ Page language="c#" Inherits="Discuz.Web.Admin.ForumDataCall" Codebehind="global_forumdatacall.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		...
		<td>
			<input type="text" name="url" id="url" value="http://nt.discuz.net" class="txt"  />
		</td>
	</tr>
	<tr>
		...
		<td class="vtop" colspan="2" style="padding:12px 0;">
			...
			<a href="http://nt.discuz.net/doc/default.aspx?cid=38" target="_blank">参数详解</a>
		</td>
	</tr>
	<tr>
		<td class="item_title">&nbsp;</td>
