...
<frameset rows="43,*" frameborder="no" border="0" framespacing="0">
  <frame src="framepage/top.aspx<%if(Request.Params["pagename"]!=null){ %>?pagename=<%=Request.Params["pagename"]%> <%} %>" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" />
