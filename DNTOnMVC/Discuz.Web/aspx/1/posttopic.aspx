...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/9/13 14:14:54.
		本页面代码由Discuz!NT模板引擎生成于 2011/9/13 14:14:54. 
	*/
	...
	string replyposter = DNTRequest.GetHtmlEncodeString("poster");
	...
	if (pagename=="posttopic.aspx"&&isbindconnect)
	{

	int userpushfeedstatus = DiscuzCloud.GetOnlineUserCloudFeedStatus(userid);
	
	bool ispublishfeed = (userpushfeedstatus&1)==1;
	
	bool ispublisht = (userpushfeedstatus&2)==2;
	
	templateBuilder.Append("\r\n            <p class=\"mbn\"><input type=\"checkbox\" value=\"1\" name=\"ispublishfeed\" id=\"ispublishfeed\" ");
	if (ispublishfeed)
	{
	...
	templateBuilder.Append(" /><label for=\"ispublishfeed\">发送动态到QQ空间</label></p>\r\n            <p class=\"mbn\"><input type=\"checkbox\" value=\"2\" name=\"ispublisht\" id=\"ispublisht\" ");
	if (ispublisht)
	{
	...
	templateBuilder.Append(" /><label for=\"ispublisht\">发送动态到微博</label></p>\r\n        ");
	}	//end if
	...
	templateBuilder.Append(editorid.ToString());
	templateBuilder.Append("_image_ctrl\" class=\"imguptype\" style=\"cursor: move;\">\r\n        <li><a onclick=\"switchImagebutton('www');\" id=\"");
	templateBuilder.Append(editorid.ToString());
	templateBuilder.Append("_btn_www\" hidefocus=\"true\" href=\"javascript:;\">网络图片</a></li>\r\n        ");
	if (canpostattach)
	{

	templateBuilder.Append("\r\n        <li><a onclick=\"switchImagebutton('imgattachlist');\" id=\"");
	templateBuilder.Append(editorid.ToString());
	templateBuilder.Append("_btn_imgattachlist\" hidefocus=\"true\" href=\"javascript:;\">图片列表</a></li>\r\n        <li><a onclick=\"switchImagebutton('imgupload');\" id=\"");
	templateBuilder.Append(editorid.ToString());
	templateBuilder.Append("_btn_imgupload\" hidefocus=\"true\" href=\"javascript:;\">普通图片上传</a></li>\r\n        <li><a onclick=\"switchImagebutton('multi');\" id=\"");
	templateBuilder.Append(editorid.ToString());
	templateBuilder.Append("_btn_multi\" hidefocus=\"true\" href=\"javascript:;\" class=\"current\">批量上传</a></li>\r\n        ");
	}	//end if

	templateBuilder.Append("\r\n    </ul>\r\n    \r\n    <div id=\"");
	templateBuilder.Append(editorid.ToString());
	templateBuilder.Append("_www\" unselectable=\"on\" class=\"p_opt popupfix\">\r\n        <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\r\n			<tr>\r\n				<th width=\"74%\">请输入图片地址<span id=\"");
	templateBuilder.Append(editorid.ToString());
