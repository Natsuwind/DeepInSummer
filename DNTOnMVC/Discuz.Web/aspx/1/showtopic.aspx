...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/9/13 14:15:03.
		本页面代码由Discuz!NT模板引擎生成于 2011/9/13 14:15:03. 
	*/
	...
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("search.aspx?q=' + escape(form.keywordf.value);\r\n        } else if (form.keywordtype.value == '8') {\r\n            form.keyword.value = '';\r\n            form.poster.value = form.keywordf.value != form.keywordf.defaultValue ? form.keywordf.value : '';\r\n        } else {\r\n            form.poster.value = '';\r\n            form.keyword.value = form.keywordf.value != form.keywordf.defaultValue ? form.keywordf.value : '';\r\n            if (form.keywordtype.value == '2')\r\n                form.type.value = 'spacepost';\r\n            if (form.keywordtype.value == '3')\r\n                form.type.value = 'album';\r\n        }\r\n    }\r\n</");
	templateBuilder.Append("script>");
	...
	templateBuilder.Append(ShowForumAspxRewrite(forum.Pathlist.Trim(),forumid,forumpid).ToString().Trim());
	...
	templateBuilder.Append("<dt>注册时间</dt><dd>");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Joindate).ToString("yyyy-MM-dd"));
	templateBuilder.Append("</dd>");
	}	//end if
	...
	templateBuilder.Append("<dt>最后登录</dt><dd>");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Lastvisit).ToString("yyyy-MM-dd"));
	templateBuilder.Append("</dd>");
	}	//end if
	...
	templateBuilder.Append("<li><label>注册时间</label>");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Joindate).ToString("yyyy-MM-dd"));
	templateBuilder.Append("</li>");
	}	//end if
	...
	templateBuilder.Append("<li><label>最后登录</label>");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Lastvisit).ToString("yyyy-MM-dd"));
	templateBuilder.Append("</li>");
	}	//end if
	...
	templateBuilder.Append("\" href=\"showtopic.aspx?topicid=");
	...
	templateBuilder.Append("&stand=");
	templateBuilder.Append(post.Debateopinion.ToString().Trim());
	templateBuilder.Append("\" class=\"v\">");
	if (post.Debateopinion==1)
	{
	...
	templateBuilder.Append("\r\n                                        <a id=\"diggs");
	templateBuilder.Append(post.Pid.ToString().Trim());
	templateBuilder.Append("\" href=\"###\" onclick=\"digg(");
	templateBuilder.Append(post.Pid.ToString().Trim());
	templateBuilder.Append(",");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append(",");
	templateBuilder.Append(post.Debateopinion.ToString().Trim());
	templateBuilder.Append(")\" class=\"b\">支持 ");
	templateBuilder.Append(post.Diggs.ToString().Trim());
	templateBuilder.Append("</a>\r\n										");
	}	//end if
	...
	templateBuilder.Append("\r\n                                        <span class=\"b\" onclick=\"alert('");
	if (isenddebate)
	{

	templateBuilder.Append("该辩论已经结束");
	}
	else
	{

	templateBuilder.Append("不能支持自己");
	}	//end if
	...
	templateBuilder.Append("\r\n					发表于 <span title=\"");	templateBuilder.Append(TypeConverter.StrToDateTime(post.Postdatetime).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\">");
	...
	templateBuilder.Append("\r\n                    <span class=\"pipe\">|</span><a href=\"buytopic.aspx?topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("&showpayments=1\">查看主题购买记录</a>\r\n                    ");
	}	//end if
	...
	templateBuilder.Append("\r\n                <p class=\"dtm\">结束时间: ");
	templateBuilder.Append(debateexpand.Terminaltime.ToString().Trim());
	templateBuilder.Append(" </p>\r\n                <div class=\"ds\">\r\n                    <table cellspacing=\"0\" cellpadding=\"0\" summary=\"全部观点\">\r\n                        <tbody>\r\n                            <tr>\r\n                                <td class=\"si_1\">\r\n                                    <div class=\"point\">\r\n                                        <strong>正方观点 (");
	templateBuilder.Append(debateexpand.Positivevote.ToString().Trim());
	templateBuilder.Append(")</strong>\r\n                                        <p>");
	...
	templateBuilder.Append("\r\n                                        <div title=\"正方 (");
	templateBuilder.Append(debateexpand.Positivevote.ToString().Trim());
	templateBuilder.Append(")\" style=\"height: ");
	templateBuilder.Append(positivepercent.ToString());
	templateBuilder.Append(";\" class=\"chart\"></div>\r\n                                    </div>\r\n                                </td>\r\n                                <th><div></div></th>\r\n                                <td class=\"sc_2\">\r\n                                    <div class=\"point_chart\">\r\n                                        ");
	...
	templateBuilder.Append("\r\n                                        <div title=\"反方 (");
	templateBuilder.Append(debateexpand.Negativevote.ToString().Trim());
	templateBuilder.Append(")\" style=\"height: ");
	templateBuilder.Append(negativepercent.ToString());
	templateBuilder.Append(";\" class=\"chart\"></div>\r\n                                    </div>\r\n                                </td>\r\n                                <td class=\"si_2\">\r\n                                    <div class=\"point\">\r\n                                        <strong>反方观点 (");
	templateBuilder.Append(debateexpand.Negativevote.ToString().Trim());
	templateBuilder.Append(")</strong>\r\n                                        <p>");
	...
	templateBuilder.Append("<button type=\"button\" class=\"pn\" onclick=\"ajaxmenu(event, this.id, 3000, debaterefresh());doane(event);\" id=\"positivebutton\" href=\"/tools/ajax.aspx?t=debatevote&tid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&stand=1\"><span>支持</span></button>");
	}	//end if
	...
	templateBuilder.Append("postreply.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&stand=1\"");
	if (canreply)
	{
	...
	templateBuilder.Append("postreply.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&stand=2\"");
	if (canreply)
	{
	...
	templateBuilder.Append("<button type=\"button\" class=\"pn\" onclick=\"ajaxmenu(event, this.id, 3000, debaterefresh());doane(event);\" id=\"negabutton\" href=\"/tools/ajax.aspx?t=debatevote&tid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&stand=2\"><span>支持</span></button>");
	}	//end if
	...
	templateBuilder.Append("class=\"xw1 a\"");
	}	//end if

	templateBuilder.Append("><a hidefocus=\"true\" href=\"showtopic.aspx?topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(pageid.ToString());
	...
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(pageid.ToString());
	templateBuilder.Append("&stand=1\">正方</a></li>\r\n            <li ");
	if (stand==2)
	{
	...
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(pageid.ToString());
	templateBuilder.Append("&stand=2\">反方</a></li>\r\n            </ul>\r\n			");
	}	//end if
	...
	templateBuilder.Append("\r\n<span  id=\"hiddenlayer\" style=\"display:none;\"></span>\r\n<div id=\"quickpost\" class=\"");
	if (infloat!=1)
	{
	...
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/editor.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n<div class=\"editor_tb\">\r\n    <span id=\"hiddenlayer\">\r\n        ");
	...
	string replyurl = rooturl+"postreply.aspx?topicid="+topicid;
	...
	templateBuilder.Append("\r\n		</div>\r\n		<a href=\"javascript:;\" title=\"附件和图片\" class=\"tb_img tb_upload\" id=\"");
	templateBuilder.Append(seditorid.ToString());
	...
	templateBuilder.Append("tools/VerifyImagePage.aspx?time=");
	templateBuilder.Append(Processtime.ToString());
	templateBuilder.Append("\" class=\"cursor\" id=\"vcodeimg' + vcodeimgid + '\" onclick=\"vcodeimg_click(this,' + vcodeimgid + ');\"/></div>';\r\n	function vcodeimg_click(obj,vcodeimgid){\r\n        obj.src='");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("tools/VerifyImagePage.aspx?id=");
	templateBuilder.Append(olid.ToString());
	...
	templateBuilder.Append(">观点</option>\r\n						<option value=\"1\"");
	if (stand==1)
	{
	...
	templateBuilder.Append(">正方</option>\r\n						<option value=\"2\"");
	if (stand==2)
	{
