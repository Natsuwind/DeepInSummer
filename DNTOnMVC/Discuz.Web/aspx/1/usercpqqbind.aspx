<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpqqbind" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/9/13 14:14:53.
		本页面代码由Discuz!NT模板引擎生成于 2011/9/13 14:14:53. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>QQ 绑定</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("><a href=\"usercpprofile.aspx?action=avatar\">设置头像</a></li>\r\n        <li ");
	if (pagename=="usercpprofile.aspx"||pagename=="usercppreference.aspx")
	{

	templateBuilder.Append(" class=\"current\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpprofile.aspx\">个人资料</a></li>\r\n        <li ");
	if (pagename=="usercpinbox.aspx"||pagename=="usercpsentbox.aspx"||pagename=="usercpdraftbox.aspx"||pagename=="usercppostpm.aspx"||pagename=="usercpshowpm.aspx"||pagename=="usercpannouncepm.aspx"||pagename=="usercpignorelist.aspx"||pagename=="usercpnotice.aspx")
	{

	templateBuilder.Append(" class=\"current\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpinbox.aspx\">短消息</a></li>\r\n        <li ");
	...
	templateBuilder.Append("><a href=\"mytopics.aspx\">我的帖子</a></li>\r\n        <li ");
	...
	templateBuilder.Append("><a href=\"myattachment.aspx\">附件</a></li>\r\n        <li ");
	...
	templateBuilder.Append("><a href=\"usercpsubscribe.aspx\">收藏夹</a></li>\r\n        ");
	...
	templateBuilder.Append("\r\n        <li ");
	if (pagename=="usercpcreditspay.aspx"||pagename=="usercpcreditstransfer.aspx"||pagename=="usercpcreditspayoutlog.aspx"||pagename=="usercpcreditspayinlog.aspx"||pagename=="usercpcreaditstransferlog.aspx")
	{

	templateBuilder.Append(" class=\"current\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpcreditspay.aspx\">积分</a></li>\r\n        <li ");
	...
	templateBuilder.Append("><a href=\"usercp.aspx\">用户组&权限</a></li>\r\n        <li ");
	...
	templateBuilder.Append("><a href=\"usercpnewpassword.aspx\">更改密码</a></li>\r\n        ");
	if (isbindconnect)
	{

	templateBuilder.Append("\r\n        <li ");
	if (pagename=="usercpqqbind.aspx")
	{

	templateBuilder.Append(" class=\"current\"");
	}	//end if

	templateBuilder.Append("><a href=\"usercpqqbind.aspx\">QQ绑定</a></li>\r\n        ");
	}	//end if
	...
	templateBuilder.Append("\r\n                <p class=\"pbm bbda xi1\">您已将本站帐号");
	templateBuilder.Append(username.ToString());
	templateBuilder.Append("与QQ号码绑定</p>\r\n		        <form id=\"setbind\" method=\"post\" action=\"\">\r\n                    <table class=\"tfm\" cellspacing=\"0\" cellpadding=\"0\">\r\n                        <tbody>\r\n                            <tr>\r\n                                <th>绑定设置</th>\r\n                                <td>\r\n                                    <label for=\"ispublishfeed\">\r\n                                        <input id=\"ispublishfeed\" class=\"pc\" type=\"checkbox\"");
	if (ispublishfeed)
	{
	...
	templateBuilder.Append(" value=\"1\" name=\"ispublishfeed\" />\r\n                                         发表主题时默认发送动态到QQ空间\r\n                                    </label>\r\n                                </td>\r\n                            </tr>\r\n                            <tr>\r\n                                <th></th>\r\n                                <td>\r\n                                    <label for=\"ispublisht\">\r\n                                        <input id=\"ispublisht\" class=\"pc\" type=\"checkbox\"");
	if (ispublisht)
	{
	...
	templateBuilder.Append(" value=\"2\" name=\"ispublisht\" />\r\n                                         发表主题时默认转播到腾讯微博\r\n                                    </label>\r\n                                </td>\r\n                            </tr>\r\n                            <tr>\r\n                                <th></th>\r\n                                <td>\r\n                                    <button value=\"yes\" class=\"pn\" name=\"connectsubmit\" type=\"submit\"><strong>保存设置</strong></button>\r\n                                </td>\r\n                            </tr>\r\n                        </tbody>\r\n                    </table>\r\n                </form>\r\n                <h2><a class=\"xi2\" href=\"connect.aspx?action=unbind\">解绑已绑定的帐号?</a></h2>\r\n		    ");
	}	//end if
