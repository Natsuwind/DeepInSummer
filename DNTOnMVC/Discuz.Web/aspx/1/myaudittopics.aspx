<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.myaudittopics" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/9/13 14:14:56.
		本页面代码由Discuz!NT模板引擎生成于 2011/9/13 14:14:56. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>未审核主题</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc c1\">\r\n	");
	...
	if (pagename=="myaudittopics.aspx")
	{

	templateBuilder.Append(" class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"myaudittopics.aspx\">未审核主题</a></li>\r\n</ul>\r\n");
	}	//end if
	...
	templateBuilder.Append("invisible=1\" target=\"_blank\"><img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/folder_old.gif\" alt=\"图例\"/></a>\r\n			</td>\r\n			<td class=\"t_img\"></td>\r\n			<td><a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	if (config.Aspxrewrite==1)
	{
	...
	templateBuilder.Append("invisible=1\" target=\"_blank\">");
