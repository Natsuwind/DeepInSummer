...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" class=\"lightlink\">" + announcement["poster"].ToString().Trim() + "</a>  发表于: <span class=\"time\">");	templateBuilder.Append(TypeConverter.StrToDateTime(announcement["starttime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
	templateBuilder.Append("</span>\r\n			结束于:<span class=\"time\">");	templateBuilder.Append(TypeConverter.StrToDateTime(announcement["endtime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
