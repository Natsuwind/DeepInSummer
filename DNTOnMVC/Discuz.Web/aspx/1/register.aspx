...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("提交注册请求");
	}
	else
	{

	templateBuilder.Append("立即注册");
	}	//end if
	...
	templateBuilder.Append("\r\n                    <div id=\"bbreg\" class=\"regbox\">\r\n                        <h3 class=\"flb\"><em id=\"returnregmessage\">注册</em>\r\n                            <span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('register')\" title=\"关闭\">关闭</a></span>\r\n                        </h3>\r\n                        <div id=\"succeedmessage\" class=\"c cl\" style=\"display:none\"></div>\r\n                        <form id=\"ajaxform\" name=\"register\" method=\"post\" onsubmit=\"$('ajaxform').action='");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("register.aspx?infloat=1&action=reg&createuser=1&';ajaxpost('ajaxform', 'returnregmessage', 'returnregmessage', 'onerror');return false;\" action=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("register.aspx?infloat=1&action=reg&createuser=1&\">\r\n                    ");
	}
	else
	{
	...
	templateBuilder.Append(verifycode.ToString());
	templateBuilder.Append("\" />\r\n				                    ");
	...
	templateBuilder.Append("\r\n									<label><em>验证码: </em><cite style=\"display:inline;position: relative;\">");
	...
	templateBuilder.Append("</cite></label>\r\n			                        ");
	}	//end if
	...
	templateBuilder.Append("\r\n                                <script type=\"text/javascript\" reload=\"1\">setTimeout(setUsernameFocus,300);</");
	templateBuilder.Append("script>\r\n                                ");
	}	//end if
	...
	templateBuilder.Append("\r\n                    <div id=\"bbreg\" class=\"regbox\">\r\n                        <h3 class=\"flb\"><em id=\"returnregmessage\">提交注册请求</em>\r\n                            <span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('register')\" title=\"关闭\">关闭</a></span>\r\n                        </h3>\r\n                        <div id=\"succeedmessage\" class=\"c cl\" style=\"display:none\"></div>\r\n                        <form id=\"ajaxform\" name=\"verify\" method=\"post\" onsubmit=\"$('ajaxform').action='");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("register.aspx?infloat=1&action=verify';ajaxpost('ajaxform', 'returnregmessage', 'returnregmessage', 'onerror');return false;\" action=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("register.aspx?infloat=1&action=verify\">\r\n                    ");
	}
	else
	{
	...
	templateBuilder.Append(config.Antispamregisteremail.ToString().Trim());
	templateBuilder.Append("\" onblur=\"checkemail(this)\" onkeyup=\"checkemail(this)\"/> *<span id=\"email_tip\"></span></label>\r\n                                    ");
	if (invitecode!=""||config.Regstatus==3)
	{

	templateBuilder.Append("\r\n				                    <label><em>邀请码:</em><input name=\"invitecode\" type=\"text\" id=\"Text1\" size=\"20\" class=\"txt\" maxlength=\"7\"");
	if (invitecode!="")
	{
	...
	templateBuilder.Append(msgbox_text.ToString());
	templateBuilder.Append("</p>\r\n            <script type=\"text/javascript\" reload=\"1\">$(\"");
	templateBuilder.Append(errorControlId.ToString());
	templateBuilder.Append("\").focus();</");
	templateBuilder.Append("script>\r\n        ");
	}	//end if
