...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	if (toptopic.Identify>0)
	{
	                        ...
	                        TopicIdentify topicidentify = Caches.GetTopicIdentify(toptopic.Identify);
	...
	templateBuilder.Append(topicidentify.Name.ToString().Trim());
	templateBuilder.Append("\" src=\"");
	templateBuilder.Append(topicidentifydir.ToString());
	templateBuilder.Append("/");
	templateBuilder.Append(smalltopicidentify.ToString());
	templateBuilder.Append("\">\r\n                        ");
	                        }
	...
	if (topic.Identify>0)
	{
	                                ...
	                                TopicIdentify topicidentify = Caches.GetTopicIdentify(topic.Identify);
	                                if(topicidentify.Identifyid!=0)
	                                {
	                                string smalltopicidentify = topicidentify.Filename.Split('.')[0] + "_small." + topicidentify.Filename.Split('.')[1];
	...
	templateBuilder.Append("\r\n                            <img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/attachment_image.gif\" alt=\"图片附件\"/>&nbsp;<img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/attachment.gif\" alt=\"附件\"/>\r\n						");
	}	//end if
	...
	templateBuilder.Append("\" name=\"htmlon\" id=\"htmlon\"/>\r\n			<input type=\"hidden\" value=\"");
	...
	templateBuilder.Append("\r\n            <input type=\"hidden\" value=\"");
	templateBuilder.Append(DiscuzCloud.GetOnlineUserCloudFeedStatus(userid).ToString().Trim());
	templateBuilder.Append("\" name=\"ispublishfeed\" id=\"ispublishfeed\" />\r\n            ");
	}	//end if
