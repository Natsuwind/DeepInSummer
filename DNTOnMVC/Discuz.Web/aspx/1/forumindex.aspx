...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/9/13 14:15:00.
		本页面代码由Discuz!NT模板引擎生成于 2011/9/13 14:15:00. 
	*/
	...
	foreach(PostInfo firsttopic in ForumHots.GetFirstPostInfo(tid,forumhotiteminfo2.Cachetimeout))
	{
	...
	string message = ForumHots.RemoveUbb(firsttopic.Message.Trim(),300);
	...
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/collapsed_no.gif\" alt=\"收起\" /></a>\r\n		");
	}
	else
	{
	...
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/collapsed_yes.gif\" alt=\"展开\" /></a>\r\n		");
	}	//end if
