...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/9/13 14:15:06.
		本页面代码由Discuz!NT模板引擎生成于 2011/9/13 14:15:06. 
	*/
	...
	templateBuilder.Append("\r\n		<form action=\"modcp.aspx?operation=manage&op=delannouncements\" method=\"post\"  class=\"datalist\">\r\n		<h1>\r\n			<span class=\"y\" style=\"font-size:12px;font-weight:normal;\">\r\n                <a href=\"modcp.aspx?operation=addannouncements&forumid=");
	templateBuilder.Append(forumid.ToString());
	...
	templateBuilder.Append(operation.ToString());
	templateBuilder.Append("\" />\r\n		<table cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\" summary=\"审核回复范围选择\">\r\n		<tbody>\r\n		<tr>\r\n			<th width=\"60\"><label for=\"forumid\">版块选择</label></th>\r\n			<td>\r\n				<div class=\"ftid\">\r\n					<select name=\"forumid\" id=\"forumid\" change=\"location.href='modcp.aspx?operation=auditpost&forumid='+jQuery('#forumid option:selected').val()+'&filter='+jQuery('#filter option:selected').val()\">\r\n						<option value=\"0\">全部</option>\r\n						");
	templateBuilder.Append(forumliststr.ToString());
	templateBuilder.Append("\r\n					</select>\r\n				</div>\r\n				<div class=\"ftid\">\r\n					<select name=\"tablelist\" id=\"tablelist\" change=\"location.href='modcp.aspx?operation=auditpost&forumid='+jQuery('#forumid option:selected').val()+'&filter='+jQuery('#filter option:selected').val()+'&tablelist='+jQuery('#tablelist option:selected').val()\" ");
	if (counts!=0)
	{
	...
	templateBuilder.Append("\r\n					</select>\r\n				</div>\r\n                <script type=\"text/javascript\">\r\n                    simulateSelect(\"forumid\",\"200\",true);\r\n                    simulateSelect(\"tablelist\");\r\n                </");
	...
	templateBuilder.Append(operation.ToString());
	templateBuilder.Append("\" />\r\n		<table cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\" summary=\"审核主题范围选择\">\r\n		<tbody>\r\n		<tr>\r\n			<th width=\"60\"><label for=\"forumid\">版块选择</label></th>\r\n			<td>\r\n				<div class=\"ftid\">\r\n					<select name=\"forumid\" id=\"forumid\" change=\"location.href='modcp.aspx?operation=audittopic&forumid='+jQuery('#forumid option:selected').val()+'&filter='+jQuery('#filter option:selected').val()\">\r\n						<option value=\"0\">全部</option>\r\n						");
	templateBuilder.Append(forumliststr.ToString());
	templateBuilder.Append("\r\n					</select>\r\n				</div>\r\n				<div class=\"ftid\">\r\n					<select name=\"tablelist\" id=\"tablelist\" change=\"location.href='modcp.aspx?operation=audittopic&forumid='+jQuery('#forumid option:selected').val()+'&filter='+jQuery('#filter option:selected').val()+'&tablelist='+jQuery('#tablelist option:selected').val()\" ");
	if (counts!=0)
	{
	...
	templateBuilder.Append("\r\n			<div class=\"hintinfo\">当您首次进入管理面板或者长时间没有管理动作时，您需要输入密码才能进入。如果密码输入错误超过 3 次，管理面板将会锁定。30 分解除锁定。</div>\r\n		");
	}	//end if
	...
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/seditor.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n					<div class=\"editor_tb\" style=\"width: 70%;\"><span class=\"y\"><a id=\"viewrule\" href=\"###\" onclick=\"preview('rulespreview','rulesmessage')\">预览</a></span>\r\n						<div>\r\n						<a href=\"javascript:;\" title=\"粗体\" class=\"tb_bold\" onclick=\"seditor_insertunit('");
	templateBuilder.Append(seditorid.ToString());
	templateBuilder.Append("', '[b]', '[/b]')\">B</a>\r\n						<a href=\"javascript:;\" title=\"颜色\" class=\"tb_color\" id=\"");
	templateBuilder.Append(seditorid.ToString());
	templateBuilder.Append("forecolor\" onclick=\"showMenu(this.id, true, 0, 2)\">Color</a>\r\n						<div class=\"popupmenu_popup tb_color\" id=\"");
