    ...
    public class attachment : PageBase
    {
        ...
        protected override void ShowPage()
        {
            ...
            else
            {
                ...
                {
                    if (DNTRequest.GetString("q") != "1")
                    {
                        HttpContext.Current.Response.Clear();
                        HttpContext.Current.Response.Redirect("/images/common/imgerror2.png");
                        HttpContext.Current.Response.End();
                        return;
                    }
                    else
                ...
                {
                    if (Scoresets.IsSetDownLoadAttachScore() && CreditsFacade.IsEnoughCreditsDownloadAttachment(userid, 1) && 
                        CreditsFacade.DowlnLoadAttachments(userid, 1) == -1)
                    {
