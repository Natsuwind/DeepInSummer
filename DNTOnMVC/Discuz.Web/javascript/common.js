        ...
        switch (tag) {
            case 'url':
                ...
                str = '<div class="pbt">请输入链接地址:</div><div class="pbt"><input type="text" id="' + ctrlid + '_param_1" sautocomplete="off" style="width: 98%" value="http://" class="txt" />' +
                    ...
                    '<div class="p_opt cl"><form onsubmit="' + submitstr + ';return false;" autocomplete="off"><div class="pns mtn"><button type="submit" id="' + ctrlid + '_submit" class="pn pnc"><strong>提交</strong></button><button type="button" onClick="hideMenu()" class="pn"><em>取消</em></button></div></form></div>';
                break;
            case 'code':
            case 'quote':
