...
function saveResult(doc, imagedir, redirect) {
    ...
    ismoder == 1 ? html += '<li class="edit_user"><a href="modcp.aspx?operation=edituser&op=edit&uid=' + posterid + '" target="_blank">编辑该用户</a></li>' : "";
    html += '			    </ul>';
    html += '			</div>';
    ...
    html += '<div class="imicons cl">';
    html += '<a href="userinfo.aspx?userid=' + uid + '" target="_blank" class="public_info">查看公共资料</a>';
    html += '<a href="search.aspx?posterid=' + posterid + '&searchsubmit=1" target="_blank" class="all_topic">搜索主题</a>';
    html += '<a href="search.aspx?posterid=' + posterid + '&type=author&searchsubmit=1" target="_blank" class="all_topic">搜索帖子</a>';
    html += '</div>';
