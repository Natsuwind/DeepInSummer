...
namespace Discuz.Web.UI
{
	...
	public class ArchiverPage : Page
	{
		...
		public ArchiverPage()
		{
            ...
            if (usergroupinfo.Groupid==1&&(ua.Contains("iphone") || ua.Contains("iemobile")))
            {
                HttpContext.Current.Response.Write("<meta name =\"viewport\" content =\"width = device-width,initial-scale = 1.0\">\r\n");
            }
