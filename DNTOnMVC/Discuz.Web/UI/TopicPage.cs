...
namespace Discuz.Web.UI
{
    ...
    public class TopicPage : PageBase
    {
        ...
        /// 获取查看列表的页数
        /// </summary>
        public int forumpid = TypeConverter.ObjectToInt(Utils.GetCookie("forumpageid"), 1);
        #endregion
        ...
        public bool ValidateForumPassword()
        {
            if (!Utils.StrIsNullOrEmpty(forum.Password) && Utils.MD5(forum.Password) != ForumUtils.GetCookie("forum" + forumid + "password"))
            {
                ...
                if (config.Aspxrewrite == 1)
                    ...
                    System.Web.HttpContext.Current.Response.Redirect(BaseConfigs.GetForumPath + "showforum.aspx?forumid=" + forumid, true);
