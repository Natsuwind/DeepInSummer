...
namespace Discuz.Data
{
    public partial interface IDataProvider
    {
        ...
        /// 获取版主可见版块
        /// </summary>
        /// <param name="uid">当前版主UID</param>
        /// <returns></returns>
        DataTable GetModerForums(int uid);
        /// <summary>
        /// 获取第一个版块ID(非版块分类)
        /// </summary>
        /// <returns></returns>
        ...
        int GetDebatePostCount(string onlyauthor, string postTableId, int tid, int posterId, int stand);
        /// <summary>
        /// 获取帖子数
        /// </summary>
        /// <param name="postTableName"></param>
        ...
        /// <returns></returns>
        IDataReader GetPostList(string topicList, string[] postTableId);
        /// <summary>
        /// 获取指定条件的帖子DataSet
        /// </summary>
        ...
        /// <param name="name">名称</param>
        /// <param name="image">图片</param>
        void InsertMedal(int medalId, string name, string image);
        /// <summary>
        /// 更新用户勋章信息
        /// </summary>
        /// <param name="uid">用户Id</param>
        ...
        /// <returns></returns>
        IDataReader GetDebatePostList(PostpramsInfo postpramsInfo, int opinion, int pageSize, int pageIndex, string postTableId, PostOrderType postOrderType);
        /// <summary>
        /// 获取指定版块下的最新回复
        /// </summary>
        ...
        IDataReader GetMyUnauditTopic(int posterId, int tpp, int pageId, int filter);
        /// <summary>
        /// 获取指定用户和分页下的通知
        /// </summary>
        /// <param name="uid">用户id</param>
        ...
        /// <param name="posterid">作者ID</param>
        /// <param name="filter">-2为未审核</param>
        int GetMyUnauditTopicCount(int posterId, int filter);
        /// <summary>
        /// 获取需要审核的回复
        /// </summary>
        /// <param name="fidList">版块ID列表</param>
        ...
        /// <param name="tid">主题ID</param>
        /// <param name="uid">用户ID</param>
        /// <returns>true：参与过投票；false：没参与过投票</returns>
        string CheckDebateVoter(int tid, int stand);

        void InsertDebateVoter(int tid, string uidList, int stand);
        /// <summary>
        ...
        /// 检查表是否存在
        /// </summary>
        /// <param name="tableName">要检查表的名称，不用加表前辍，如：要检查dnt_users表，只需参数给定users</param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        int CreateVerifyRegisterInfo(VerifyRegisterInfo verifyInfo);
        /// <summary>
        /// 根据code获取验证注册请求信息
        /// </summary>
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        IDataReader GetVerifyRegisterInfo(string code, string type);
        /// <summary>
        /// 销毁验证注册请求信息
        /// </summary>
        /// <param name="regId"></param>
        /// <returns></returns>
        int DeleteVerifyRegisterInfo(int regId);
        /// <summary>
        /// 创建用户的互联信息
        /// </summary>
        /// <param name="userConnectInfo"></param>
        /// <returns></returns>
        int CreateUserConnectInfo(UserConnectInfo userConnectInfo);
        /// <summary>
        /// 更新用户的互联信息
        /// </summary>
        /// <param name="userConnectInfo"></param>
        /// <returns></returns>
        int UpdateUserConnectInfo(UserConnectInfo userConnectInfo);
        /// <summary>
        /// 根据openid获取用户的互联信息
        /// </summary>
        /// <param name="openId"></param>
        /// <returns></returns>
        IDataReader GetUserConnectInfo(string openId);
        /// <summary>
        /// 根据uid获取用户的互联信息
        /// </summary>
        /// <param name="userId"></param>
        /// <returns></returns>
        IDataReader GetUserConnectInfo(int userId);
        /// <summary>
        /// 删除指定的用户互联信息
        /// </summary>
        ...
        /// <returns></returns>
        int DeleteUserConnectInfo(int uid, string openId, string type);
        /// <summary>
        /// 创建主题pushfeed到云平台的日志
        /// </summary>
        /// <param name="feedInfo"></param>
        /// <returns></returns>
        int CreateTopicPushFeedLog(TopicPushFeedInfo feedInfo);
        /// <summary>
        ...
        /// <param name="tid"></param>
        /// <returns></returns>
        IDataReader GetTopicPushFeedLog(int tid);
        /// <summary>
        ...
        /// <param name="tid"></param>
        /// <returns></returns>
        int DeleteTopicPushFeedLog(int tid);
        /// <summary>
        /// 创建用户绑定QQ的记录
        /// </summary>
        /// <param name="bindLog"></param>
        /// <returns></returns>
        int CreateUserConnectBindLog(UserBindConnectLog bindLog);
        /// <summary>
        /// 更新用户绑定QQ的记录
        /// </summary>
        /// <param name="bindLog"></param>
        /// <returns></returns>
        int UpdateUserConnectBindLog(UserBindConnectLog bindLog);
        /// <summary>
        /// 获取用户绑定QQ的记录
        /// </summary>
        /// <param name="openId"></param>
        /// <returns></returns>
        IDataReader GetUserConnectBindLog(string openId);
    }
}
