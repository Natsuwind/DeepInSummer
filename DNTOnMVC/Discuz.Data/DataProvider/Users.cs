...
namespace Discuz.Data
{
    public class Users
    {
        ...
        /// <returns></returns>
        public static VerifyRegisterInfo GetVerifyRegisterInfo(string code, string type)
        {
            IDataReader reader = DatabaseProvider.GetInstance().GetVerifyRegisterInfo(code, type);
            VerifyRegisterInfo verifyInfo = null;

            if (reader.Read())
            {
                verifyInfo = LoadVerifyRegisterInfoExtra(reader);
                reader.Close();
            }
            return verifyInfo;
        }
        ...
        {
            return DatabaseProvider.GetInstance().DeleteVerifyRegisterInfo(regId);
        }
