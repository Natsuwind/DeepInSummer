...
namespace Discuz.Data
{
    public class Posts
    {
        ...
        {
            return LoadPostInfoList(DatabaseProvider.GetInstance().GetUnauditNewPost(fidList, ppp, pageIndex, postTableId, filter));
        }
        ...
        /// <returns></returns>
        public static List<PostInfo> GetPostList(string tidList, string[] postTableIdArray)
        {
            return LoadPostInfoList(DatabaseProvider.GetInstance().GetPostList(tidList, postTableIdArray));
        }

        private static List<PostInfo> LoadPostInfoList(IDataReader reader)
        {
