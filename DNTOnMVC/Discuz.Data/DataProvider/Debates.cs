    ...
    public class Debates
    {
        ...
        {            
            ...
            if (debatetopic.Read())
            {
                ...
                topicexpand.Positivevote = TypeConverter.ObjectToInt(debatetopic["positivevote"]);
                topicexpand.Positivevoterids = debatetopic["positivevoterids"].ToString();
                topicexpand.Negativevote = TypeConverter.ObjectToInt(debatetopic["negativevote"]);
                topicexpand.Negativevoterids = debatetopic["negativevoterids"].ToString();
                topicexpand.Tid = tid;
            }
            debatetopic.Close();
            return topicexpand;
        ...
        {
            return Discuz.Data.DatabaseProvider.GetInstance().CheckDebateVoter(tid,stand);
        }

        public static void InsertDebateVoter(int tid, string uidList, int stand)
        {
            Discuz.Data.DatabaseProvider.GetInstance().InsertDebateVoter(tid, uidList, stand);
        }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="onlyauthor"></param>
        /// <param name="postTableId"></param>
        /// <param name="topicId"></param>
        /// <param name="posterId"></param>
        /// <param name="stand"></param>
        /// <returns></returns>
        public static int GetDebatePostCountByPosterId(string onlyauthor, string postTableId, int topicId, int posterId, int stand)
        {
            return DatabaseProvider.GetInstance().GetDebatePostCount(onlyauthor, postTableId, topicId, posterId, stand);
        }
    }
}
