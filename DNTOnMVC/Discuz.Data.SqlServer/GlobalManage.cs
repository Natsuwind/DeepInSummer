...
namespace Discuz.Data.SqlServer
{
    public partial class DataProvider : IDataProvider
    {
        ...
        {
            return DbHelper.ExecuteScalar(CommandType.Text, string.Format("SELECT OBJECT_ID('[{0}{1}]')",BaseConfigs.GetTablePrefix,tableName)).ToString() != "";
        }
        ...
        public string GetSpecialTableFullIndexSQL(string tableName, string dbName)
        {
            ...
            sqlBuilder.Append("[posterid] [int] NOT NULL ,[title] [nvarchar] (80) NOT NULL ,[postdatetime] [datetime] NOT NULL ,");
            ...
            sqlBuilder.Append("CREATE INDEX [IX_{0}_fid] ON [{0}](fid,tid,posterid) INCLUDE (title,postdatetime,poster);");
            sqlBuilder.Append("CREATE INDEX [IX_{0}_posterid] ON [{0}] (posterid,tid,pid) INCLUDE (postdatetime);");
