...
namespace Discuz.Data.SqlServer
{
    public partial class DataProvider : IDataProvider
    {
        ...
        public void InsertMedal(int medalId, string name, string image)
        {
            DbParameter[] parms =
            {
				DbHelper.MakeInParam("@medalid", (DbType)SqlDbType.SmallInt,2, medalId),
            ...
            string commandText = string.Format("INSERT INTO [{0}medals] (name,medalid,image) Values(@name,@medalid,@image)",
                                                BaseConfigs.GetTablePrefix);
            DbHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
    ...
    UPDATE [{0}users] SET [credits] = {1} WHERE [uid] = @uid", BaseConfigs.GetTablePrefix, creditExpression);
        ...
        /// <summary>
        /// 根据verifyCode获取验证注册请求信息
        /// </summary>
        /// <param name="code"></param>
        /// <returns></returns>
        public IDataReader GetVerifyRegisterInfo(string code, string type)
        {
            return DbHelper.ExecuteReader(CommandType.StoredProcedure, string.Format("{0}getverifyreg", BaseConfigs.GetTablePrefix),
                DbHelper.MakeInParam("@field", (DbType)SqlDbType.NChar, 50, code),
                DbHelper.MakeInParam("@type", (DbType)SqlDbType.NChar, 10, type));
        }
        ...
        /// <returns></returns>
        public int DeleteVerifyRegisterInfo(int regId)
        {
            return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, string.Format("{0}deleteverifyreg", BaseConfigs.GetTablePrefix),
                DbHelper.MakeInParam("@regid", (DbType)SqlDbType.Int, 4, regId));
        }
        ...
        /// <returns></returns>
        public int CreateUserConnectInfo(UserConnectInfo userConnectInfo)
        {
            DbParameter[] parms = {
            ...
            return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, string.Format("{0}createuserconnect", BaseConfigs.GetTablePrefix), parms);
        }
        ...
        /// <returns></returns>
        public IDataReader GetUserConnectInfo(string openId)
        {
            return DbHelper.ExecuteReader(CommandType.StoredProcedure, string.Format("{0}getuserconnect", BaseConfigs.GetTablePrefix),
                DbHelper.MakeInParam("@openid", (DbType)SqlDbType.Char, 32, openId));
        }
        ...
        /// <returns></returns>
        public IDataReader GetUserConnectInfo(int userId)
        {
            return DbHelper.ExecuteReader(CommandType.StoredProcedure, string.Format("{0}getuserconnectbyuid", BaseConfigs.GetTablePrefix),
    DbHelper.MakeInParam("@uid", (DbType)SqlDbType.Int, 4, userId));
        }
        ...
        /// <returns></returns>
        public int DeleteUserConnectInfo(int uid, string openId, string type)
        {
            DbParameter[] parms ={
                                     DbHelper.MakeInParam("@openid",(DbType)SqlDbType.Char,32,openId),
                                     DbHelper.MakeInParam("@uid",(DbType)SqlDbType.Int,4,uid),
            ...
            return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, string.Format("{0}deleteuserconnect", BaseConfigs.GetTablePrefix), parms);
        }
        ...
        /// <returns></returns>
        public int CreateUserConnectBindLog(UserBindConnectLog bindLog)
        {
            DbParameter[] parms = { 
            ...
            return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, string.Format("{0}createbindlog", BaseConfigs.GetTablePrefix), parms);
        }
        ...
        /// <param name="openId"></param>
        /// <returns></returns>
        public IDataReader GetUserConnectBindLog(string openId)
        {
            return DbHelper.ExecuteReader(CommandType.StoredProcedure, string.Format("{0}getbindlog", BaseConfigs.GetTablePrefix), 
                DbHelper.MakeInParam("@openid", (DbType)SqlDbType.Char, 32, openId));
        }
    }
}
