...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/5/24 17:48:00.
		本页面代码由Discuz!NT模板引擎生成于 2011/5/24 17:48:00. 
	*/
	...
	templateBuilder.Append("\r\n        <p>\r\n            <a href=\"javascript:;\" onclick=\"location.reload()\" class=\"xg2\">如果长时间没有响应请点击此处</a></p>\r\n        <script type=\"text/javascript\">            setTimeout('location.reload()', 3000);</");
	templateBuilder.Append("script>\r\n        ");
	}	//end if
	...
	templateBuilder.Append("\r\n        <h3 class=\"flb\">\r\n            <em id=\"returnmessage\">用户登录</em><span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('login')\"\r\n                title=\"关闭\">关闭</a></span></h3>\r\n        <div id=\"succeedmessage\" class=\"c cl\" style=\"display: none\">\r\n        </div>\r\n        <form id=\"form1\" name=\"form1\" method=\"post\" onsubmit=\"javascript:$('form1').action='");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("login.aspx?infloat=1&';ajaxpost('form1', 'returnmessage', 'returnmessage', 'onerror');return false;\"\r\n        action=\"");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("\r\n                <div class=\"ftid sltp\" style=\"margin-bottom: 10px\">\r\n                    <select name=\"question\" id=\"question\" change=\"changequestion();\" tabindex=\"1003\">\r\n                        <option value=\"0\">安全提问</option>\r\n                        <option onclick=\"loadselect_liset('question', 0, 'question','1',this.innerHTML, 1)\"\r\n                            value=\"1\" k_id=\"question\">母亲的名字</option>\r\n                        <option onclick=\"loadselect_liset('question', 0, 'question','2',this.innerHTML, 2)\"\r\n                            value=\"2\" k_id=\"question\">爷爷的名字</option>\r\n                        <option onclick=\"loadselect_liset('question', 0, 'question','3',this.innerHTML, 3)\"\r\n                            value=\"3\" k_id=\"question\">父亲出生的城市</option>\r\n                        <option onclick=\"loadselect_liset('question', 0, 'question','4',this.innerHTML, 4)\"\r\n                            value=\"4\" k_id=\"question\">您其中一位老师的名字</option>\r\n                        <option onclick=\"loadselect_liset('question', 0, 'question','5',this.innerHTML, 5)\"\r\n                            value=\"5\" k_id=\"question\">您个人计算机的型号</option>\r\n                        <option onclick=\"loadselect_liset('question', 0, 'question','6',this.innerHTML, 6)\"\r\n                            value=\"6\" k_id=\"question\">您最喜欢的餐馆名称</option>\r\n                        <option onclick=\"loadselect_liset('question', 0, 'question','7',this.innerHTML, 7)\"\r\n                            value=\"7\" k_id=\"question\">驾驶执照的最后四位数字</option>\r\n                    </select>\r\n                    <script type=\"text/javascript\">                        simulateSelect('question', '214');</");
	...
	templateBuilder.Append("script>\r\n                </div>\r\n                <div class=\"sltp\" style=\"clear: both;\">\r\n                    <input type=\"text\" tabindex=\"1004\" class=\"txt\" size=\"36\" autocomplete=\"off\" style=\"display: none;\"\r\n                        id=\"answer\" name=\"answer\" /></div>\r\n                ");
	}	//end if
