<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="LiteCMS.Web.space.postblog" %>
...
{
	/*
	This is a cached-file of template("\templates\templatename\postblog.htm"), it was created by LiteCMS.CN Template Engine.
	Please do NOT edit it.
	此文件为模板文件的缓存("\templates\模板名\postblog.htm"),由 LiteCMS.CN 模板引擎生成.
	所以请不要编辑此文件.
	*/
	base.OnInit(e);
	...
	templateBuilder.Append("		<div class=\"div-header\">写日志</div>\r\n");
	...
	templateBuilder.Append("                                (\r\n");
	templateBuilder.Append("                                    {\r\n");
	templateBuilder.Append("                                        url:'../cms/uploadfile.aspx',\r\n");
