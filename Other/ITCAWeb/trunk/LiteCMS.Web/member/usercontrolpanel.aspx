<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="LiteCMS.Web.usercontrolpanel" %>
...
{
	/*
	This is a cached-file of template("\templates\templatename\usercontrolpanel.htm"), it was created by LiteCMS.CN Template Engine.
	Please do NOT edit it.
	此文件为模板文件的缓存("\templates\模板名\usercontrolpanel.htm"),由 LiteCMS.CN 模板引擎生成.
	所以请不要编辑此文件.
	*/
	base.OnInit(e);
	...
	templateBuilder.Append("		        <th>邮箱: </th><td>");
	templateBuilder.Append(userinfo.Email.ToString().Trim());
	...
	templateBuilder.Append("		    <li style=\"border-bottom:1px solid #666; line-height:200%;\"><a href=\"showarticle-");
	...
	templateBuilder.Append("</a><span style=\"margin-left:10px\">");
