...
namespace LiteCMS.Data.MySql
{
    public partial class DataProvider : IDataProvider
    {
        ...
        public System.Data.IDataReader GetArticles(int cid, int pagesize, int currentpage)
        {
            ...
            DbParameter[] prams = 
		    {
			    DbHelper.MakeInParam("?columnid", (DbType)MySqlDbType.Int32, 4,cid),
        ...
        public IDataReader GetArticles(string cids, int pagesize, int currentpage)
        {
            ...
            DbParameter[] prams = 
		    {
			    DbHelper.MakeInParam("?columnids", (DbType)MySqlDbType.String, 100,cids),
			    DbHelper.MakeInParam("?recordoffset", (DbType)MySqlDbType.Int32, 4,recordoffset),
			    DbHelper.MakeInParam("?pagesize", (DbType)MySqlDbType.Int32, 4,pagesize)
		    };
            if (cids.Trim() != "")
        ...
        public IDataReader GetArticleInfo(int articleid)
        {
            ...
            DbParameter[] prams = 
		    {
			    DbHelper.MakeInParam("?articleid", (DbType)MySqlDbType.Int32, 4,articleid)
		    };
        ...
        public void ChangeCommentCount(int articleid, int changevalue, int type)
        {
		    ...
		    {
			    DbHelper.MakeInParam("?articleid", (DbType)MySqlDbType.Int32, 4,articleid),
			    DbHelper.MakeInParam("?increasevalue", (DbType)MySqlDbType.Int32, 4,changevalue)
		    };
