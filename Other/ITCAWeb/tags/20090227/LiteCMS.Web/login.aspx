<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="LiteCMS.Web.login" %>
...
{
	/*
	This is a cached-file of template("\templates\templatename\login.htm"), it was created by LiteCMS.CN Template Engine.
	Please do NOT edit it.
	此文件为模板文件的缓存("\templates\模板名\login.htm"),由 LiteCMS.CN 模板引擎生成.
	所以请不要编辑此文件.
	*/
	base.OnInit(e);
	...
	templateBuilder.Append("		<div class=\"div-header\">用户登录</div>		\r\n");
	templateBuilder.Append("		<form action=\"\" method=\"post\" id=\"login\">\r\n");
	templateBuilder.Append("		<table>\r\n");
	templateBuilder.Append("		    <tr>\r\n");
	templateBuilder.Append("		        <th>帐号: </th><td><input id=\"loginid\" name=\"loginid\" type=\"text\" />(请输入注册邮箱作为帐号)</td>\r\n");
	templateBuilder.Append("		    </tr>\r\n");
	templateBuilder.Append("		    <tr>\r\n");
